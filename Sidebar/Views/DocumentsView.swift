...
struct DocumentsView: View {
    @State private var documents = [
        ...
        DocumentItem(id: 3, name: "Design Mockups.sketch", type: .image, size: "15.2 MB", dateModified: Date().addingTimeInterval(-172800)),
        DocumentItem(id: 4, name: "Budget Spreadsheet.xlsx", type: .spreadsheet, size: "456 KB", dateModified: Date().addingTimeInterval(-259200))
    ]
